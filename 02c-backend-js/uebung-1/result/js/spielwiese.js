function run() {
     ...
     */
    console.log(`Zwei Ganzzahlen als Number: ${calcSum(1, 3)}`);
    console.log(`Zwei Flieskommazahlen als Number: ${calcSum(2.3, 3.1)}`);
    console.log(`Eine Ganzzahl als String und eine Ganzzahl als Number: ${calcSum('1', 3)}`);
    console.log(`Eine Ganzzahl als Number und ein alphanumerischer String: ${calcSum(1, 'test')}`);
    console.log(`Fuer beide undefined: ${calcSum(undefined, undefined)}`);
     ...
     */
    const serializedCalc = JSON.stringify(calcObject);
    console.log(serializedCalc);
     ...
     */
    const deserializedCalc = JSON.parse(serializedCalc);
    console.log(`Die Addition von ${deserializedCalc.value1} und ${deserializedCalc.value2} ergibt ${deserializedCalc.sum}`);
}
...
function calcSum(value1, value2) {
    ...
    console.error(`Die Parameter ${value1} und ${value2} sind keine validen Ganzzahlen`);
    return undefined;
}